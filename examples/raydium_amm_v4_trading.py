...
async def main() -> None:
    ...
    buy_params = example_buy_params(DexType.RAYDIUM_AMM_V4)
    sell_params = example_sell_params(DexType.RAYDIUM_AMM_V4)

    describe_dry_run("Raydium AMM v4 trading example")
