...
async def main() -> None:
    ...
    buy_params = example_buy_params(DexType.METEORA_DAMM_V2)
    sell_params = example_sell_params(DexType.METEORA_DAMM_V2)

    describe_dry_run("Meteora DAMM v2 trading example")
